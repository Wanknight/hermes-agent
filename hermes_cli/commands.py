...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mode", "Switch agent mode: default (single) or three_provinces (multi-agent)", "Configuration",
               args_hint="[default|three_provinces|status]",
               subcommands=("default", "three_provinces", "status", "on", "off")),
    CommandDef("tasks", "List multi-agent tasks and their status", "Configuration",
               args_hint="[status|stats|<task_id>]"),
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("circuit-breaker", "Show or reset circuit breaker status for multi-agent",
               "Tools & Skills", cli_only=True, args_hint="[status|reset]",
               subcommands=("status", "reset"), aliases=("cb",)),
    CommandDef("events", "Show event bus history and statistics",
               "Tools & Skills", cli_only=True, args_hint="[stats|<task_id>]",
               subcommands=("stats",)),
